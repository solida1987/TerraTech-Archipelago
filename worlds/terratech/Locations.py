...
from .Data import (BLOCKS, CAMPAIGN_MISSIONS, CORPORATIONS, QUEST_MILESTONES,
                   TIERS, split_by_tier)
...
def mission_locations() -> dict[str, int]:
    return {f"Complete {m}": BASE_ID + _MISSION + i
            for i, m in enumerate(CAMPAIGN_MISSIONS)}
